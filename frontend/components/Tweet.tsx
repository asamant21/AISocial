  ...
  return (
    <div className='p-4 cursor-pointer border-b border-zinc-700 hover:bg-gray-600 hover:bg-opacity-30 w-1/2'>
      <div className='flex flex-row items-start justify-between space-x-3'>
        ...
        <div className='flex flex-col flex-1' style={{display: 'flex', justifyContent: 'center'}}>
          <div className='flex items-center justify-between mt-1' onClick={handleToggleLike}>
            <div className={`text-[${color}] text-sm  flex items-center space-x-2 bg-transparent  hover:bg-slate-100 rounded-3xl hover:bg-opacity-10 p-2 hover:text-sky-400`} style={{margin: 'auto'}}>
