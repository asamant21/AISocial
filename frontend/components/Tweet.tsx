...
const Tweet = ({ tweet }: Props) => {
  ...
  const tweet_content = content + "\n -" + author.handle + "\n\n" + "This twitter was generated by an AI through GPTwitter"
  ...
  return (
    <div className='p-4 cursor-pointer border-b border-zinc-700 hover:bg-gray-600 hover:bg-opacity-30 w-1/2'>
      <div className='flex flex-row items-start justify-between space-x-3'>
        ...
        <div>
        <a href={`https://twitter.com/intent/tweet?url=https://gptwitter-neon.vercel.app&text=${tweet_content}`} target="_blank" rel="noreferrer">Share on Twitter</a>
        </div>
      </div>
    </div>
  );
