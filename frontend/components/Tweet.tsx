  ...
  return (
    <div className='p-4 cursor-pointer border-b border-zinc-700 hover:bg-gray-600 hover:bg-opacity-30 w-1/2'>
      <div className='flex flex-row items-start justify-between space-x-3'>
        ...
        <div className='flex flex-col flex-1' style={{display: 'flex', justifyContent: 'center'}}>
          <TwitterShareButton className='flex items-center justify-between mt-1' url={"https://gptwitter-neon.vercel.app/"} title={content + "\n-" + author.handle + "\n\nThis tweet was generated by AI with GPTwitter."}> 
            <TwitterIcon round size={30}  style={{margin: 'auto'}}/>
          </TwitterShareButton>
        </div>
      </div>
    </div>
